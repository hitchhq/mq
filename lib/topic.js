...
function TopicMQ (options) {
  ...
  this.reuseChannel = options.reuseChannel === undefined ? true : options.reuseChannel;
};
...
TopicMQ.prototype.publish = function (topic, content, options) {
  ...
  const create_channel = this.reuseChannel ? (this.channel || this.createChannel()) : this.createChannel();
  options = options || {};
